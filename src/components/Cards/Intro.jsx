  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center w-screen">
      ...
      <div className="relative mr-[60px] -mt-5">
        <img src={head} alt="3D avatar head image" className="tossing max-w-[200px] ml-[70px] animate-[] absolute " />
        <img src={shoulder} alt="3D avatar shoulder image" className="max-w-[330px] mt-[16px]" />
      </div>
